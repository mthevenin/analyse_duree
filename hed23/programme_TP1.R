...
# dipl1 versus dipl2
# Pendant la formation, le problème était simple: sans le ifelse j'avais 
# laissé la valeur 3 dans la condition
...
coxfit = coxph(Surv(dur,d) ~   diplome, data=act)
summary(coxfit)
...
coxfit2 = coxph(Surv(dur, d) ~  dipl1 + dipl3 + tt(dipl3), data = act, tt = function(x, t, ...) x*t)
summary(coxfit2)
