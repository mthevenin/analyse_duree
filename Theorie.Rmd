...
<strong>Durée continue</strong> : absence (ou très peu) d’évènements simultanés.   
<strong>Durée discrète/groupée</strong> : présence d’évènements simultanés (en grand nombre).
...
<div class="alert alert-info">
<strong>Une observation est dite censurée lorsque la durée d'observation est inférieure à la durée d'exposition au risque</strong>.  
</div>
