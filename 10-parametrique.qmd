...
streg year age surgery, dist(weibull) time tr noheader nolog
```
...
streg year age surgery, dist(weibull)  hr  noheader nolog
```
...
stpm2 year age surgery  , df(2) scale(hazard) nolog eform
```
