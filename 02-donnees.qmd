...
-	Avantages: 
  - Qualité des données et techniquement l'absence de biais de mémoire^[Cet avantage peut se trouver contrebalancé par des phénomènes de censure par intervalles, donc de *trous* tout aussi problématique que ceux liés à la mémoire].
