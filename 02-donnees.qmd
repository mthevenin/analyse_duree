...
::: {.box_img}
![Biographie et entourage: base biographique logements](images/Image2.png){group="survey"}
:::
...
::: {.box_img} 
![MAFE: base caractéristiques individuelles](images/Image3.png){group="survey"}
:::
