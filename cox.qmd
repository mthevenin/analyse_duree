...
Une maj va être réalisé en novembre, pour préciser le plus clairement possible la différences entre le test simplifié (Stata, Sas, R jusqu'à la v3) et le test exact (R à partir de la V3).
::: 
