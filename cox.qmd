...
*   On peut tester l'hypothèse sur les résidus par une régression entre
    ...
    de la durée, par exemple $t$ ou $log(t)$)). La solution la plus utilisée
    est le test de **Grambsch-Therneau** sous sa forme simplifiée (R jusqu'à v3 de `survival`, Sas, Stata, Python) ou exacte (R depuis la V3).   
