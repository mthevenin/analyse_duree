...
# installation survival v2.44-1 (30 mars 2019) => problÃÂ¨me test Grambsch-Therneau
#require(remotes)
...
# technique de lissage avec de nombreux paramÃ¨tre. Ici paramÃ¨tres par dÃ©faut.
...
### certains conseille d'estimer un gls (generalized least square => correlation des erreurs de la regression dans le temps)
...
## duree groupee/discrete (le debut vise pour l'exemple a regrouper les durees)
