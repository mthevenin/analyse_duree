...
Il convient également de préciser dans une analyse la version du test qui a été exécutée.
:::
...
***Test simplifié (celui que j'utilise)***
...
Estimé simplement à partir d'une OLS
