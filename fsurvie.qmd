...
-   L'introduction d'une dimension dynamique, la greffe, est donnée par les informations présentent dans les
...
-   Méthode, hélas, de plus en plus abandonnée dans les sciences sociales ou les durées sont plus rarement mesurées de manière exacte. L'absence de test de comparaison des fonctions de survie n'y est pas étranger.
