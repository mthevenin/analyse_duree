...
Au final:  
Après de brefs échanges avec la rédaction en chef de l'Ined^[Nous étions 3 à avoir exprimé de l'étonnement sur le contenu de cet article], il a été convenu qu'il ne s'agissait pas en effet d'une analyse de durée ou de survie....Ouf!.... Mais que l'autrice, via une réponse peu inspirée^[D'un spécialiste de l'Ined sur les questions de fécondité...pas un.e méthodologue], n'avait pas souhaité faire une analyse de ce type... Ha bon?
